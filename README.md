...
Pokemon Lab is a collection of casual Pokemon reference and game stations. No account is required. The application supports bookmarkable station routes, browser Back/Forward navigation, compact Continue shortcuts for saved tasks, remembered station choices, accessible dialogs, and an optional `Limit animations` preference. On smaller screens, long station controls collapse behind dedicated toggles.
